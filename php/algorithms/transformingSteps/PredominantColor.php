...
class PredominantColor
{
    ...
    static $green=array(
        93,99,123,124,125,128,129,130,131,134,135,136,140,141,154,155,158,159,160,161,
        164,165,166,167,170,171,172,173,176,177,178,179,180,188,190,191,194,195,196,197,
        200,201,202,203,204,206,207,208,209,210,212,213,214,215,216,224,225,226,227,230,
        231,232,233,234,236,237,238,239,240,242,243,244,245,246,248,249,250,251,252,260,
        261,262,263,264,266,267,268,269,270,272,273,274,275,276,278,279,280,281,282,284,
        285,286,287,288,308,309,310,311,314,315,316,317,320,321,322,323);

    //6) Диапазоны относящиеся к желтому
    static $yellow = array(101,106,107,94,95,90,96,100,102,105,108,126,132,137,138,142,
        143,144,156,162,168,174,516);
    ...
    //Подсчитываем доминантные цвета
